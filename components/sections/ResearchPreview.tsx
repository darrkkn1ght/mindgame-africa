        ...
        >
          ...
          <Card variant="navy" className="mt-6 max-w-[860px]">
            ...
            <p className="mt-5 text-cream/80 text-base md:text-lg leading-relaxed max-w-[620px]">
              We are building a research agenda around performance under
              pressure, behaviour, coaching, athlete development, team
              environments and the realities of performance practice in Africa.
            </p>
            <div className="mt-8">
